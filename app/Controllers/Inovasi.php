...
class Inovasi extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['logo_footer']= '/news/img/2222221.png';
    ...
    public function dinsos_cgt()
    {
        ...
        $data['logo']= '/img/dinsos_cgt.png';
        $data['logo_footer']= '/img/2222222.png';
        ...
        $data['cili']= $this->db->query("SELECT DISTINCT(judul),tgl,image,link,isi,team,youtube FROM inovasi where team='dinsos_cgt' ORDER BY RAND() LIMIT 0, 5; ")->getResult();
        // change array to object
        // $data['headline']= $query->getRow();
        // $this->kepesertaan->select('*');
        // $query2 = $this->kepesertaan->get();
